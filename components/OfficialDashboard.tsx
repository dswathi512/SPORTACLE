  ...
  return (
    <main className="container mx-auto p-4 md:p-6 space-y-8">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h2 className="text-3xl font-extrabold text-brand-dark">Official Analytics Dashboard</h2>
          <p className="text-brand-gray">Transparent insights for nationwide talent identification.</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-6 rounded-2xl shadow-md">
          <h3 className="font-bold text-xl text-brand-dark mb-4">Athlete Distribution by Sport</h3>
          <DistributionBarChart data={athletesBySport} />
        </div>
        <div className="bg-white p-6 rounded-2xl shadow-md">
          <h3 className="font-bold text-xl text-brand-dark mb-4">Top 5 Athletes (Overall Percentile)</h3>
            ...
            <table className="w-full text-sm text-left text-brand-dark">
              <thead className="text-xs text-brand-gray uppercase bg-brand-light">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3">Athlete</th>
                  <th scope="col" className="px-6 py-3">Sport</th>
                  <th scope="col" className="px-6 py-3 text-right">Avg. Percentile</th>
                </tr>
              </thead>
              <tbody>
